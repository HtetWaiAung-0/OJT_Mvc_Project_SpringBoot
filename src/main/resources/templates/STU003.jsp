...
<body>
  <div id="testheader">
    ...
    <div id="sub_content">
      <form:form class="row g-3 mt-3 ms-2" action="searchStu" method="post" modelAttribute="stuBean">
        <div class="col-auto">
        ...
        <c:set var="count" value="${count+1 }" scope="page"/>
          <tr>
           ...
           <c:forEach items="${data.stuAttend}" var = "a">
            ...
            <td>
              <a href="updateStuPage/${data.stuId }"><button type="button" class="btn btn-secondary mb-2">See More</button></a> 
            </td>
          </tr>
         </c:forEach>
        </tbody>
