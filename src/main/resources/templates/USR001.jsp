...
<body>
    ...
    <div id="sub_content">
        ...
        <form:form action ="addUser" method ="post" modelAttribute="userBean">
            ...
            <div class="row mb-4">
                <div class="col-md-2"></div>
                <form:label for="confirmPassword" class="col-md-2 col-form-form:label" path="userConPassword" >Confirm Passowrd</form:label>
                <div class="col-md-4">
                    <form:input type="password" class="form-control" id="confirmPassword"  path ="userConPassword" />
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalform:label">Student Registration</h5>
